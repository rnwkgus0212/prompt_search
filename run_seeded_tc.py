...
if dataset_name == "agnews":
    temp = AgnewsProcessor().get_test_examples("./datasets/TextClassification/AG")
        ...
        try:
            ...
            if single_tag.startswith(allowed_pos):
                if wordnet.synsets(processed_word):
                    if len(processed_word) >= 4 and len(processed_word) <= 12:
                        filtered_targets.append(unprocessed_word)
...
dataset['test'] = AgnewsProcessor().get_test_examples("./datasets/TextClassification/AG")
